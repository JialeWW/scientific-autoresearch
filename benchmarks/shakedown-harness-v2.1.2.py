#!/usr/bin/env python3
"""Run the non-development protocol-2.1.2 execution shakedown fixture."""
...
SPEC = importlib.util.spec_from_file_location(
    "scientific_autoresearch_benchmark_score_2_1_2", SCORER_PATH
)
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=HERE / "executions" / "shakedown-v2.1.2",
    )
